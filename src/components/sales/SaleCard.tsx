...
export function SaleCard({ property }: SaleCardProps) {
  return (
      ...
      <div className="p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <div className="rounded-2xl bg-[#f8f3ef] p-3">
            <div className="text-[11px] uppercase tracking-[0.14em] text-[#8f6d5a]">Type</div>
            <div className="mt-1 text-sm font-medium text-[#3f2b22]">{property.type}</div>
          </div>
          <div className="rounded-2xl bg-[#f8f3ef] p-3">
            <div className="text-[11px] uppercase tracking-[0.14em] text-[#8f6d5a]">Surface</div>
            <div className="mt-1 text-sm font-medium text-[#3f2b22]">{property.surface}</div>
          </div>
        </div>
        <div className="mt-4 flex items-end justify-between gap-4">
          <div>
            <div className="text-xs uppercase tracking-[0.14em] text-[#8f6d5a]">Prix</div>
            <div className="mt-1 text-2xl font-semibold text-[#4a2a20]">{property.price}</div>
          </div>
          <span className="inline-flex rounded-full border border-[#eaded5] bg-[#fcfaf8] px-5 py-3 text-sm font-semibold text-[#8f6d5a]">
            Dossier sur demande
          </span>
        </div>
      </div>
